...
setup_logging(f"stdout_trapped_map_perfect_{resolution}_{comm_size}.txt")
...
for boozmn_filename in boozmn_filenames:
    ...
    for Bcrit in Bcrits:
        ...
        # if verbose:
        poinc.plot_poincare(filename=f'{output_dir}/trapped_map_perfect_{boozmn_filename}_Bcrit_{Bcrit}.png',save_data=True, data_filename=f'{output_dir}/trapped_map_perfect_{boozmn_filename}_Bcrit_{Bcrit}.npz')
        omega_eta_prof, omega_b_prof, s_prof = poinc.compute_frequencies()
        np.savez(f'{output_dir}/frequencies_perfect_{boozmn_filename}_Bcrit_{Bcrit}.npz', omega_eta_prof=omega_eta_prof, omega_b_prof=omega_b_prof, s_prof=s_prof)
