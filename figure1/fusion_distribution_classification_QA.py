...
boozmn_filename = "../inputs/forpaper/boozmn_equil_G1600_DESC_fixed.nc"
out_dir = "QA_t1e-1"
helicity_M = 1
...
if comm is None or comm.rank == 0:
    os.makedirs("outputs/"+out_dir, exist_ok=True)
if comm is not None:
    comm.Barrier()
...
nfp = field.nfp
helicity_N = 0  # helicity of field strength contours
